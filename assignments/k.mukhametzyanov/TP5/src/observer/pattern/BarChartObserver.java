...
public class BarChartObserver extends JPanel implements Observer {
	...
	public void paint(Graphics g) {
		...
		for (int i = 0; i < courseData.size(); i++) {
			...
			int layout = LayoutConstants.xOffset + (i + 1)
					* LayoutConstants.barSpacing + i
					* LayoutConstants.barWidth;
			g.fillRect(
					layout, LayoutConstants.yOffset
	...
	static void addIfFound(Object args, Vector<CourseRecord> courseData) {
