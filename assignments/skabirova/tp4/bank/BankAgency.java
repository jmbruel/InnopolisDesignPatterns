...
public class BankAgency {
	...
	public void print() {
		...
		ApplicationContextBankAgency.getInstance().getPrintWriter().println();
		ApplicationContextBankAgency.getInstance().getPrintWriter().println("Name: " + this.name + " (" + this.loc + ")");
		ApplicationContextBankAgency.getInstance().getPrintWriter().println("" + this.accounts.size() + " Accounts:");
		nbC = this.accounts.size();
		for (i = 0; i < nbC; i++) {
			cTemp = accounts.get(i);
			cTemp.print();
			ApplicationContextBankAgency.getInstance().getPrintWriter().println("   Balance: " + cTemp.balance());
		}
		ApplicationContextBankAgency.getInstance().getPrintWriter().println();
	}
