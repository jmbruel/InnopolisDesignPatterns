...
public class CourseData extends Observable {
	...
	@Override
	public void attach(Observer o, boolean subscribeForAddition, boolean subscribeForChange) {
		super.attach(o, subscribeForAddition, subscribeForChange);
		if(subscribeForAddition) this.courseAdditionObservers.add(o);
		if(subscribeForChange) this.courseChangeObservers.add(o);
	}
