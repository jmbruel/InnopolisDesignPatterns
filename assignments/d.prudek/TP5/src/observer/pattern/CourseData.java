...
public class CourseData extends Observable {
	...
	public CourseData() {
        ...
        public void attach(Observer o, boolean subscribeAddition, boolean subscribeForUpdate) {
		super.attach(o);
		if(subscribeAddition) this.courseAdditionObservers.add(o);
		if(subscribeForUpdate) this.courseChangeObservers.add(o);
	}
...
boolean alreadyExists = false;
		...
		if (!alreadyExists) {
			...
			this.notifyObservers(courseRecord, true, true);
		}
	}
