...
public class CourseViewer extends JFrame implements ActionListener,
	...
	public CourseViewer() {
		...
		constraints.gridx = 1;
		constraints.gridy = 0;
		// the bar & pie chart will be drawn over this panel
	...
	public void paint(Graphics g) {
		...
		if (total != 0) {
			...
			for (int i = 0; i < sliders.size(); i++) {
				...
				g.fillArc(LayoutConstants.xOffset, LayoutConstants.yOffsetPie, 2 * radius, 2 * radius, (int) startAngle, (int) ratio);
				startAngle += ratio;
			}
		}
	}
