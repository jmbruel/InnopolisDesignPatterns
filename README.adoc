...
- {baseMaterial}/inno-1-Intro.html[HTML] / {baseMaterial}/inno-1-Intro.deckjs.html[Slides]
- {baseMaterial}/TD1-uk.html[TD1] / {baseMaterial}/TP1.html[TP1] => assignment 1
...
- Graded issues: successful merge requests (10% bonus) A list of graded issues will be available on the {baseURL}[Github repo board].
...
- pass:[<i class="fa fa-calendar"></i>] https://doodle.com/mm/jeanmichelbruel/book-a-time[Book an]
