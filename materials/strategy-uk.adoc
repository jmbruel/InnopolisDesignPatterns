...
====
.The interface in `PHP` (code source link:src/php/Formater.php[here])
[source,php]
------
...
[NOTE,formater-icon.png]
====
.The `Writer` abstract class (code source link:src/php/Writer.php[here])
[source,php]
------
...
====
.The `FileWriter` class (code source link:src/php/FileWriter.php[here])
[source,php]
------
...
====
.The `DBWriter` class (code source link:src/php/DBWriter.php[here])
[source,php]
------
...
====
.The `TextFormater` class (code source link:src/php/TextFormater.php[here])
[source,php]
------
...
.The `HTMLFormater` class (code source link:src/php/HTMLFormater.php[here])
[source,php]
------
...
.The `XMLFormater` class (code source link:src/php/XMLFormater.php[here])
[source,php]
------
